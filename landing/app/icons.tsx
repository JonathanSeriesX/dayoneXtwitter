/* Inline SVGs — no icon dependency. Each is sized by its container (.seg svg
   or .cta svg) and inherits currentColor. */
...
export function CoffeeIcon() {
  return (
    ...
    >
      ...
      <path d="M8 2c0 1-1 1.5-1 2.5S8 6 8 6M12 2c0 1-1 1.5-1 2.5S12 6 12 6" />
    </svg>
  );
}
