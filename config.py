...
STATUSES_FILE_PATH = os.path.join(
    script_dir, "statuses.txt"
)  # Path to store processed tweet IDs
...
)  # Default is llama3.1, can be configured
OLLAMA_PROMPT = (
...
)  # tweet itself comes right afterwards
