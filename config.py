...
LLM_MAX_IMAGES = 4  # How many attached images to show the LLM per entry (0 to disable vision)
...
If the tweet is too short, vague, or unclear to title honestly, reply with exactly: Tweeted"""  # Tweet content follows afterwards
